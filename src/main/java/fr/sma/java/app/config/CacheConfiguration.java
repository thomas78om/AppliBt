package fr.sma.java.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.sma.java.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.sma.java.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
